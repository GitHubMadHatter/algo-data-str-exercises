...
class Graph(Generic[T]):
    ...
    Recall: Given our Adjacency List Structure, each edge object points to the 
    2 vertices it connects, and the vertex objects also points back to the incident edges.   
